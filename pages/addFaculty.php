...
if (isset($_POST['u_add_submit'])) {
    ...
    $addStdInfoQuery =   "INSERT INTO users_tbl(u_email,u_password,u_name,r_id_fk) VALUES('$u_email', '$u_password','$uName', 2)";
    $fire1 = mysqli_query($con, $addStdInfoQuery);
    $last_id = mysqli_insert_id($con);
    $addStdQuery =   "INSERT INTO faculty_tbl(fac_info_fk) VALUES('$last_id')";
