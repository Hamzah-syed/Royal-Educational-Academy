...
if (isset($_POST['uUpdateSubmit'])) {
    ...
    if ($fire1) header("location:./allAdmins.php");
}
    ...
    <div id="wrapper">
        ...
        <form class="customcontainer" name="addAdmin" id="addAdmin" action="<?php $_SERVER['PHP_SELF'] ?>" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" name="u_name" id="u_name" class="form-control" aria-describedby="emailHelp" value="<?php echo $student['u_name']; ?>" placeholder="Enter Name" required>
                <!-- <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small> -->
            </div>
            <div class="form-group">
                <label for="exampleInputEmail1">Email</label>
                <input type="email" name="u_email" id="u_email" class="form-control" aria-describedby="emailHelp" value="<?php echo $student['u_email']; ?>" placeholder="Enter email" required>
                <!-- <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small> -->
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="u_pass" id="u_pass" class="form-control" value="<?php echo $student['u_password']; ?>" placeholder="Password" required>
            </div>
