...
<body>
    <form class="customcontainer" name="addStudent" id="addAdmin" action="<?php $_SERVER['PHP_SELF'] ?>" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" name="std_Name" id="std_Name" class="form-control" aria-describedby="emailHelp" placeholder="Enter Name">
            <!-- <small id="emailHelp" class="form-text text-muted">text</small> -->
        </div>
        <div class="form-group">
            <label for="exampleInputEmail1">Email</label>
            <input type="email" name="std_email" id="std_email" class="form-control" aria-describedby="emailHelp" placeholder="Enter email">
        ...
        <div class="form-group">
            ...
            <input type="password" name="std_pass" id="std_pass" class="form-control" placeholder="Password">
        </div>
