...
<body>
    <form class="customcontainer" name="addStudent" id="addAdmin" action="<?php $_SERVER['PHP_SELF'] ?>" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" name="std_Name" id="std_Name" class="form-control" aria-describedby="emailHelp" value="<?php echo $student['u_name'];?>" placeholder="Enter Name">
            <!-- <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small> -->
        </div>
        <div class="form-group">
            <label for="exampleInputEmail1">Email</label>
            <input type="email" name="std_email" id="std_email" class="form-control" aria-describedby="emailHelp" value="<?php echo $student['u_email'];?>" placeholder="Enter email">
            <!-- <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small> -->
        </div>

        <div class="form-group">
            <label for="exampleInputbatch">Batch Code</label>
            <select name="std_batch" id="std_batch"  class="form-control">
        ...
        <div class="form-group">
            ...
            <input type="text" name="std_rollNum" id="std_rollNum" class="form-control" value="<?php echo $student['std_rollNumber'];?>" placeholder="Roll Number">
        </div>
        <div class="form-group">
            <label for="exampleInputPassword1">Password</label>
            <input type="text" name="std_pass" id="std_pass" class="form-control" value="<?php echo $student['u_password'];?>" placeholder="Password">
        </div>
